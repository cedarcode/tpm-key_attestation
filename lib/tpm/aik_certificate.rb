...
module TPM
  ...
  class AIKCertificate < SimpleDelegator
    ...
    OID_TCG = "2.23.133"
    OID_TCG_AT_TPM_MANUFACTURER = "#{OID_TCG}.2.1".freeze
    OID_TCG_AT_TPM_MODEL = "#{OID_TCG}.2.2".freeze
    OID_TCG_AT_TPM_VERSION = "#{OID_TCG}.2.3".freeze
    OID_TCG_KP_AIK_CERTIFICATE = "#{OID_TCG}.8.3".freeze
